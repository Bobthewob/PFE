...
namespace STM.GDA.DataAccess
{
    ...
    partial void OnJobChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK_Deploiement_Environnement", Storage="_Environnement", ThisKey="EnvironnementId", OtherKey="Id", IsForeignKey=true)]
		public Environnement Environnement
		{
			get
			{
    ...
    partial void OnEstDefaultChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK_Deploiement_Environnement", Storage="_Deploiements", ThisKey="Id", OtherKey="EnvironnementId", DeleteRule="NO ACTION")]
		public EntitySet<Deploiement> Deploiements
		{
			get
			{
